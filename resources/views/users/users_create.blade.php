                ...
                <form action="{{ url('users') }}" method="post">
                    ...
                    <div id="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="full_name" aria-describedby="full_nameHelp" placeholder="Enter Nama ..." name="full_name" value="{{ old('full_name') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="date_of_birth" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" placeholder="Enter Tgl Lahir" data-target="#date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}" required />
