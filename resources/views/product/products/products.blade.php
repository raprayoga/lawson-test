        ...
        <div class="card-header">
            ...
            <div class="row mt-3">
                <div class="col-6 offset-6 text-right">
                    <a href="{{ url('/product/products/create') }}" class="btn btn-info"><i class="fas fa-plus-circle"></i> Add Products</a>
                </div>
            </div>
        </div>
        <!-- /.card-header -->
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="text-center">
                            <div class="row">
                                <form action="{{ url('/product/products/'.$data->product_id) }}" onsubmit="return confirm('Do you really want to delete it?');" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <a href="{{ url('/product/products/'.$data->product_id.'/edit') }}" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit" style="color: white;"></i></a>
