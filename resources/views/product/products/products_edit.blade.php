...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="container">
                <form action="{{ url('product/products/'.$data->product_id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div id="form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-info" data-dropdown-css-class="select2-info" name="merchant_id" style="width: 100%;">
                                ...
                                <option value="{{ $merchant->id }}" <?php if ($data->merchant_id == $merchant->id) echo 'selected' ?>>{{ $merchant->merchant_name }}</option>
                                @endforeach
                            </select>
