...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="container">
                <form action="{{ url('product/city') }}" method="post">
                    @csrf
                    <div id="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="longitude" aria-describedby="longitudeHelp" placeholder="Enter Longitude ..." name="longitude" value="{{ old('longitude') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="latitude" aria-describedby="latitudeHelp" placeholder="Enter Latitude ..." name="latitude" value="{{ old('latitude') }}" required>
