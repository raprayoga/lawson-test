...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="container">
                <form action="{{ url('product/merchant') }}" method="post">
                    @csrf
                    <div id="form">
                        <div class="form-group">
                            <label for="merchant_name">Merchant Nama*</label>
                            <input type="text" class="form-control" id="merchant_name" aria-describedby="merchant_nameHelp" placeholder="Enter Nama ..." name="merchant_name" value="{{ old('merchant_name') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="phone" aria-describedby="phoneHelp" placeholder="Enter Phone" name="phone" value="{{ old('phone') }}" required>
                            @if ($errors->get('phone'))
                            <div class="invalid-feedback" style="display: block;">
                                <ul style="list-style: none;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="textarea" name="address" placeholder="Enter Address" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('address') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="expired_date" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" placeholder="Enter Tgl Lahir" data-target="#expired_date" name="expired_date" value="{{ old('expired_date') }}" required />
