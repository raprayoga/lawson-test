...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="container">
                <form action="{{ url('orders/master-status/'.$data->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div id="form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="textarea" name="description" placeholder="Enter description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $data->description }}</textarea>
