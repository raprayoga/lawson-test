...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="container">
                <form action="{{ url('orders/order-item/'.$data->order_id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div id="form">
                        <div class="form-group">
                            <label for="quantity">Quantity*</label>
                            <input type="number" class="form-control" id="quantity" aria-describedby="quantityHelp" placeholder="Enter Quantity ..." name="quantity" value="{{ $data->quantity }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-info" data-dropdown-css-class="select2-info" name="product_id" style="width: 100%;">
                                ...
                                <option value="{{ $product->product_id }}" <?php if ($data->product_id  == $product->product_id) echo 'selected' ?>>{{ $product->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-info" data-dropdown-css-class="select2-info" name="user_id" style="width: 100%;">
                                ...
                                <option value="{{ $user->id }}" <?php if ($data->user_id  == $user->id) echo 'selected' ?>>{{ $user->full_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-info" data-dropdown-css-class="select2-info" name="status_id" style="width: 100%;">
                                ...
                                <option value="{{ $status->id }}" <?php if ($data->status->status_id  == $status->id) echo 'selected' ?>>{{ $status->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="date" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" placeholder="Enter Date" data-target="#date" name="date" value="{{ $data->date }}" required />
